    ...
    if (admin) {
        ...
        <div class="header__container">
            ...
            <div class="header__container-hrefs-block">
                <a class="header__container-hrefs-block-result" download href="/api/results"><i class="fas fa-download header__container-hrefs-block-result" download href="/api/results"></i> Result</a>
